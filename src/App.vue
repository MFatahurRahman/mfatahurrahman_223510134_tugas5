...
<template>
  ...
  <a href="#">
    ...
    <img class="h-8 w-auto" src="/download.jpg" alt="Company Logo" />
  </a>
</div>
  ...
  <a href="#" class="flex items-center text-gray-700 hover:text-gray-800">
    <img src="/Indonesia.jpg" alt="Indonesian Flag" class="block h-auto w-5 flex-shrink-0" />
    <span class="ml-3 block text-sm font-medium">IDR</span>
    <span class="sr-only">, change currency</span>
  </a>
</div>
